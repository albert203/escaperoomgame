	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_21_0_g48 = CentralUV998;
				...
				float2 temp_output_10_0_g48 = (( ( temp_output_21_0_g48 * ( pow( saferPower6_g48 , Spherize1078 ) * Flatness1076 ) ) + float2( 0.5,0.5 ) )*( 2.0 / ( Scale1080 * 1.5 ) ) + ( Wind1035 * float2( 0.5,0.5 ) ));
				...
				float lerpResult15_g48 = lerp( saturate( ( voroi35_g48 + voroi13_g48 ) ) , voroi11_g48 , ( ModifiedCohesion1074 * 1.1 ));
				float lerpResult16_g48 = lerp( lerpResult15_g48 , 1.0 , ( ( 1.0 - CumulusCoverage376 ) + -0.7 ));
				float temp_output_1183_0 = saturate( (0.0 + (( Dot1071 * ( 1.0 - lerpResult16_g48 ) ) - 0.6) * (1.0 - 0.0) / (1.0 - 0.6)) );
				...
				float2 temp_output_21_0_g50 = ShadowUV997;
				...
				float4 lerpResult1206 = lerp( CloudHighlightColor334 , ModifiedCloudColor1165 , saturate( SampleGradient( gradient1198, saturate( (0.0 + (( Dot1071 * ( 1.0 - lerpResult16_g50 ) ) - 0.6) * (1.0 - 0.0) / (1.0 - 0.6)) ) ).r ));
...
/*ASEBEGIN
Version=18935
0;1080;2194.286;607.5715;2099.934;670.1196;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1178;-763.9213,-2272.838;Inherit;True;Ghibli Clouds;-1;;48;bce7362c867d47d49a15818b7e6650d4;0;7;37;FLOAT2;0,0;False;21;FLOAT2;0,0;False;19;FLOAT;1;False;20;FLOAT;1;False;23;FLOAT;1;False;24;FLOAT;0;False;27;FLOAT;0.5;False;2;FLOAT;33;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1192;-667.9213,-1520.838;Inherit;True;Ghibli Clouds;-1;;50;bce7362c867d47d49a15818b7e6650d4;0;7;37;FLOAT2;0,0;False;21;FLOAT2;0,0;False;19;FLOAT;1;False;20;FLOAT;1;False;23;FLOAT;1;False;24;FLOAT;0;False;27;FLOAT;0.5;False;2;FLOAT;33;FLOAT;0
...
ASEEND*/
//CHKSM=A6F0BC5AF97557D340E55585F6434096E0B9DEB8